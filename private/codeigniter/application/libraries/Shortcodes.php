...
class Shortcodes{
    ...
    public function replaceShortCodeWithHTML($index, $html)
    {
        ...
        //loop through all the short codes and update their start and end position, starting at the end
        //for ($i = 0; $i < sizeof($this->shortcodes); $i++)
        for ($i = sizeof($this->shortcodes)-1; $i > 0; $i--)
        {
		...
		echo "this->shortcodes[i]->getStart() = \n";
		var_dump($this->shortcodes[$i]->getStart());
		echo "\n\n";
		...
		echo "this->shortcodes[index]->getStart() = \n";
		var_dump($this->shortcodes[$index]->getStart());
		echo "\n\n";
		
		echo "this->shortcodes[i]->moveBy(diff) = \n";
		var_dump($this->shortcodes[$i]->moveBy($diff));
		echo "\n\n";
		...
		echo "this->adapted_string = \n";
		var_dump($this->adapted_string);
		echo "\n\n";
    }
