...
(function($){
	...
	function initVideo(elm, index)
	{
		...
		video_html = video_html + '<object width="100%" height="100%" type="application/x-shockwave-flash" data="http://fpdownload.adobe.com/strobe/FlashMediaPlayback.swf"><param name="movie" value="http://fpdownload.adobe.com/strobe/FlashMediaPlayback.swf"></param><param name="flashvars" value="src=' + base_url + 'assets/video/' + filename_NoExt[0] + '.mp4"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><p>Your browser does not support HTML5 video.</p></object>';
